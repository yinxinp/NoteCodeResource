...
{
  console.log("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
  // 下面是寄生+组合继承方法 上面的继承方式 call的时候调用了一下超类的构造方法，在后面为子类绑定prototype的时候又调用了一下超类的构造方法而且产生了重复的属性在prototype中
  function Parent() {
    this.parent = "parent";
    Parent.prototype.howManyProperties = function() {
  ...
  function myExtends(parent, child) { //在这里实现继承父类的原型
  ...
  Child.prototype.sayHi = function() {
    console.log(`Hi, I am ${this.child}!`);
  };

  let child01 = new Child();
  child01.sayHi();
  console.log(child01.howManyProperties());
}
